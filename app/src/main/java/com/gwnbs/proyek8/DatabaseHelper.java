...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME + "(" + COL1 + " integer primary key, "                + COL2 + " TEXT, "                + COL3 + " datetime, "                + COL4 + " TIME" + ")";
    ...
    public ArrayList<ModelData> getAllData() {
        ...
        String asc = " ASC";
        String koma = ",";
        String query = "SELECT * FROM " + TABLE_NAME + " ORDER BY " + COL3 + asc + koma + COL3 + asc;
